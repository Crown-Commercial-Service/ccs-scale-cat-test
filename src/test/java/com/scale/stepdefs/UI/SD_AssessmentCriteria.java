...
public class SD_AssessmentCriteria {
    /**
     ...
     */
    public SD_AssessmentCriteria(TestContext testContextObj, ScenarioContext scenarioContext) {
     ...
     */
    @When("Buyer clicks on Add or Edit link for {string} page")
    public void buyerClicksOnAddEditLinkForPage(String linkName) {
        objectManager.getAssessmentCriteriaObj().clickAddEditLink(linkName);
    }
}
