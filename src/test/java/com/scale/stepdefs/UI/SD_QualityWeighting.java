...
public class SD_QualityWeighting {
     ...
     */
    public SD_QualityWeighting(TestContext testContextObj, ScenarioContext scenarioContext) {
    ...
    public void buyerEntersWeightingForQuality() {
        String data =TestContext.OneFCTestDataMap.get(TestContext.TDID).get("S42_quality weighting");
        objectManager.getQualityWeightingObj().setQualityWeighting(data);
    }
}
